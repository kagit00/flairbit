...
This document focuses on architectural structure and module boundaries rather than production deployment, tuning, or operational metrics.
---
...
* **Tech:** Project Reactor, Kafka (asynchronous job orchestration), PostgreSQL `COPY`.
---
## Technology Stack
...
* **Stateless Design:** The application is designed to be stateless, allowing horizontal scaling in environments that support multiple instances behind a load balancer.
...
* **Horizontal Scaling:** Stateless services support running multiple instances in appropriate environments.
* **Efficient Caching:** Redis is used to reduce database load for hot data like user profiles and OTPs.
* **Batch Processing:** The Matches Import module is optimized for bulk database operations, designed to support large-volume batch imports efficiently.
---
## Security Highlights
