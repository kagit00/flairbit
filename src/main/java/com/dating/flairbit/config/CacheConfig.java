...
public class CacheConfig {
    ...
    @Bean(name = "otpCache")
    public Cache<String, OtpEntry> otpCache() {
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory, @Qualifier("redisObjectMapper") ObjectMapper redisObjectMapper) {
        CaffeineCacheManager caffeineCacheManager = new CaffeineCacheManager("otpCache", "rateLimitCache");
        ...
        RedisCacheManager redisCacheManager = RedisCacheManager.builder(redisConnectionFactory)
                ...
                .withCacheConfiguration("userCache", redisConfig.entryTtl(Duration.ofMinutes(30)))
                .withCacheConfiguration("mediaCache", redisConfig.entryTtl(Duration.ofMinutes(10)))
