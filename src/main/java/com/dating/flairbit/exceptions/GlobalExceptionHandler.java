...
import com.dating.flairbit.models.Error;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles NoSuchElementException and constructs a response containing an error object with details like
     * error message, HTTP status, and other meta-information.
     *
     * @param e the NoSuchElementException being handled
     * @return a ResponseEntity containing the error details and an associated BAD_REQUEST HTTP status
     */
