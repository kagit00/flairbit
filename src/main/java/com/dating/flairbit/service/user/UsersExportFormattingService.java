...
public interface UsersExportFormattingService {
    ExportedFile exportCsv(List<UserExportDTO> userDtos, String groupId, UUID domainId);
    List<String> extractEligibleUsernames(List<UserExportDTO> userDtos, String groupId);
}
